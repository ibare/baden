...
export function useTimelineLayout(
  ...
  const timeMap = useMemo(() => {
    ...
    return buildCompressedTimeMap(filteredItems, rangeStart, rangeEnd, ppm, viewportWidth, nowMs);
  }, [items, activeCategories, rangeStart, rangeEnd, ppm, viewportWidth, nowMs]);
